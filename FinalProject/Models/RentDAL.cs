...
namespace FinalProject.Models
{
    public class RentDAL
    {
        ...
        public static RentModel GetForRentByPostal(string postal_code, int beds)//Adjust here
        {
            ...
            string url = $"https://us-real-estate.p.rapidapi.com/v2/for-rent-by-zipcode?zipcode={postal_code}&limit=10&offset=0&sort=lowest_price&beds={beds}&property_type=townhome,single_family,condo";
