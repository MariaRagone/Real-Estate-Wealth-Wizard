...
public class Data
{
    ...
    public Suppression_Flags suppression_flags { get; set; }
...
public class Rdc
{
    ...
    public string status { get; set; }
    public object sold_date { get; set; }
}
...
public class Suppression_Flags
{
    public bool has_suppress_foreclosure { get; set; }
    public bool has_suppress_all_offmarket_photos { get; set; }
    public bool has_suppress_sold_info { get; set; }
}
